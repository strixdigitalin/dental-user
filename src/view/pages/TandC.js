  ...
  return (
    <>
      ...
      >
        ...
        <p>
          Welcome to <strong>Bobprep</strong> (&ldquo;Company&rdquo;,
        ...
        <p>
          ...
          <strong>bobprep.com</strong> (together or individually
          &ldquo;Service&rdquo;) operated by <strong>Bobprep</strong>.
        </p>
        <p>
        ...
        <p>
          ...
          <strong>support@bobprep.com</strong> so we can try to find a solution.
        ...
        <p>
          ...
          you automatically authorize Bobprep to charge all Subscription fees
          incurred through your account to any such payment instruments.
        </p>
        <p>
          Should automatic billing fail to occur for any reason, Bobprep
          reserves the right to terminate your access to the Service with
          immediate effect.
        </p>
        <p>
          6. <strong>Free Trial</strong>
        </p>
        <p>
          Bobprep may, at its sole discretion, offer a Subscription with a free
        ...
        <p>
          ...
          Trial, you will not be charged by Bobprep until Free Trial has
        ...
        <p>
          At any time and without notice, Bobprep reserves the right to (i)
          modify Terms of Service of Free Trial offer, or (ii) cancel such Free
          Trial offer.
        </p>
        <p>
          7. <strong>Fee Changes</strong>
        </p>
        <p>
          Bobprep, in its sole discretion and at any time, may modify
        ...
        <p>
          Bobprep will provide you with a reasonable prior notice of any change
        ...
        <p>
          8. <strong>Refunds</strong>
        </p>
        <p>
          We issue refunds for Contracts within <strong>30 days</strong> of the
        ...
        <p>
          Bobprep has the right but not the obligation to monitor and edit all
          Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of Bobprep or used with permission. You may not distribute, modify,
        ...
        <p>
          10. <strong>Prohibited Uses</strong>
        </p>
        <p>
        ...
        <p>
          12. <strong>No Use By Minors</strong>
        </p>
        <p>
        ...
        <p>
          14. <strong>Intellectual Property</strong>
        </p>
        <p>
          Service and its original content (excluding Content provided by
          users), features and functionality are and will remain the exclusive
          property of Bobprep and its licensors. Service is protected by
          ...
          without the prior written consent of Bobprep.
        </p>
        <p>
          15. <strong>Copyright Policy</strong>
        </p>
        <p>
        ...
        <p>
          ...
          to support@bobprep.com, with the subject line: &ldquo;Copyright
        ...
        <p>
          You can contact our Copyright Agent via email at support@bobprep.com.
        </p>
        <p>
          17. <strong>Error Reporting and Feedback</strong>
        </p>
        <p>
          You may provide us either directly at support@bobprep.com or via third
        ...
        <p>
          18. <strong>Links To Other Web Sites</strong>
        </p>
        <p>
          Our Service may contain links to third party web sites or services
          that are not owned or controlled by Bobprep.
        </p>
        <p>
          Bobprep has no control over, and assumes no responsibility for the
        ...
        <p>
          19. <strong>Disclaimer Of Warranty</strong>
        </p>
        <p>
        ...
        <p>
          20. <strong>Limitation Of Liability</strong>
        </p>
        <p>
        ...
        <p>
          22. <strong>Governing Law</strong>
        </p>
        <p>
          These Terms shall be governed and construed in accordance with the
          laws of New York, United States, which governing law applies to
        ...
        <p>
          23. <strong>Changes To Service</strong>
        </p>
        <p>
        ...
        <p>
          24. <strong>Amendments To Terms</strong>
        </p>
        <p>
        ...
        <p>
          25. <strong>Waiver And Severability</strong>
        </p>
        <p>
        ...
        <p>
          26. <strong>Acknowledgement</strong>
        </p>
        <p>
        ...
        <p>
          27. <strong>Contact Us</strong>
        </p>
        <p>
          Please send your feedback, comments, requests for technical support by
          email: <strong>support@bobprep.com</strong>.
        </p>
        <p>
          If you have any questions about this Agreement, please contact us by
          email above or regular mail at the following address:
          <br />
          Bobprep
          <br />
          31 W 34th Street Manhattan, New York 10001
          <br />
